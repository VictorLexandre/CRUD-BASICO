...
<h2 id="titulo"><i><b>Editar Usuário :</b></i></h2>
    ...
    <form method="post" action="">
        ...
        <div style="margin-left: 5%; margin-right: 5%" class="row mb-3">
            ...
            <div class="col-sm-12">
                ...
                <input type="text" class="form-control" id="senha" name="senha"value="<?=$usuarios->senha?>" required>
            </div>
        </div>
        <button style="width: 25%; margin-right: 12%;" type="submit" class="btn btn-success"><b>Salvar</b></button>
